...
一個小而美的 Python 計算機，使用 Tkinter GUI + headless 計算核心。PR-03 增加 Date Calculator、Standard Mode Memory Keys，並把模式邏輯整理到 headless controllers，方便測試與後續擴充。
...
目前 PR-03 自動化測試覆蓋 Standard arithmetic、MemoryStore、DateCalculator、mode controllers、Programmer converter 與 lightweight UI coordination。
